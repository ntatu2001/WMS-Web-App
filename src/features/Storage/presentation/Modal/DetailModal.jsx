                ...
                <div style={{marginTop: "10%", width: "100%"}}>
                      ...
                      <div style={{display: "flex", marginLeft: "-1%",justifyContent: "space-between"}}>
                                <Label style={{width: "60%"}}>Thể tích sử dụng:</Label>
                                 <span style={{ fontSize: "14px", fontWeight: 600, marginTop : "1%"}}>{data.selectedDetails?.usableVolume >= data.selectedDetails?.maxVolume ? data.selectedDetails?.maxVolume.toFixed(2) : data.selectedDetails?.usableVolume.toFixed(2)}</span>
                      </div>
                      ...
                      <div style={{display: "flex", marginLeft: "-9%", justifyContent: "space-between"}}>
                                <Label style={{width: "60%"}}>Tỷ lệ lấp đầy:</Label>
                                 <span style={{ fontSize: "14px", fontWeight: 600, marginTop : "1%"}}>{data.selectedDetails?.usableVolume >= data.selectedDetails?.maxVolume ? "100%" : ((data.selectedDetails?.usableVolume / data.selectedDetails?.maxVolume) * 100).toFixed(2) + "%"}</span>
                      </div>
                </div>
              </div>
